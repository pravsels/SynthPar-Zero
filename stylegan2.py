...
class MappingNetwork(torch.nn.Module):
    ...
    def forward(self, z, cond, truncation_psi=1, truncation_cutoff=None, update_emas=False):
        ...
        with torch.autograd.profiler.record_function('input'):
            ...
            if self.c_dim > 0:
                misc.assert_shape(cond, [None, self.c_dim])
                y = normalize_2nd_moment(self.embed(cond.to(torch.float32)))
